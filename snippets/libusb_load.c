...
/************LOAD libusb dynamically from the DLL file******/
...
libusb_submit_transfer_t       libusb_submit_transfer_d;
libusb_set_debug_t             libusb_set_debug_d;
libusb_set_log_cb_t            libusb_set_log_cb_d;
libusb_ref_device_t            libusb_ref_device_d;
libusb_unref_device_t          libusb_unref_device_d;
...
int load_libusb(void)
{
    ...
    if (!load_one((void**)&libusb_submit_transfer_d, "libusb_submit_transfer")) return -1;
    if (!load_one((void**)&libusb_set_debug_d, "libusb_set_debug")) return -1;

    if (!load_one((void**)&libusb_set_log_cb_d, "libusb_set_log_cb")) return -1;
    if (!load_one((void**)&libusb_ref_device_d, "libusb_ref_device")) return -1;
    if (!load_one((void**)&libusb_unref_device_d, "libusb_unref_device")) return -1;
