...
#ifndef LIBUSB_LOAD_H_INCLUDED
#define LIBUSB_LOAD_H_INCLUDED
#ifndef LIBUSB_DYN_H
#define LIBUSB_DYN_H
...
typedef void  (*libusb_set_log_cb_t)(libusb_context *ctx, libusb_log_cb cb, int mode);
...
typedef int (*libusb_handle_events_t)
 ...
 typedef int  (LIBUSB_CALL *libusb_handle_events_timeout_t)(libusb_context *ctx,
                                                           struct timeval *tv);


typedef void (*libusb_fill_bulk_transfer_t) ( 	struct libusb_transfer *  	transfer,
...
extern   libusb_set_debug_t              libusb_set_debug_d;

extern libusb_set_log_cb_t              libusb_set_log_cb_d;

extern libusb_ref_device_t               libusb_ref_device_d;
extern libusb_unref_device_t            libusb_unref_device_d;
// Loader
